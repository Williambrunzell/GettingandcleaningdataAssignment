...
6. A tidy data set was created by taking the mean of each measurment per subject per activity (data was grouped by subject and activity and a mean was calculated for each variable). 
7. A text file was created containing the tidy data set. 
